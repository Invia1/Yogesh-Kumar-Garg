...
namespace LINQExample
{
    ...
    class EmployeesOperation
    {
        ...
        public void SearchEmployee()
        {
            ...
            Console.WriteLine(" enter the employee name which you want to search  and you will get first occurance of that name");
            string name = Console.ReadLine();


            Employee searchedEmployee = employees.FirstOrDefault(emp => emp.EmpName == name);
