...
namespace LINQExample
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            Employee resultEmp2 = employees.OrderBy(emp => emp.Salary).ElementAtOrDefault(0);

            Console.WriteLine("Employee which salary is minimum");
            ...
            {
                Console.WriteLine("No manager at  given index");
            }
            Console.ReadKey();
        }
    }
